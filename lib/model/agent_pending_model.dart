...
class Agentpendingmodel {
  ...
  Agentpendingmodel({this.isSuccess, this.responseMessage, this.responseData});

  factory Agentpendingmodel.fromJson(Map<String, dynamic> json) =>
      Agentpendingmodel(
        isSuccess: json["success"],
        responseMessage: json["message"],
        responseData: json["data"] == null ? null : Data.fromJson(json["data"]),
      );
...
class Data {
  ...
  Data({this.adminpayment, this.pending});
