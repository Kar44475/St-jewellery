...
import 'package:stjewellery/ECommerceModule/Data/ChainsData.dart';
import 'package:stjewellery/ECommerceModule/ProductDetailsPage.dart';
import 'package:stjewellery/Utils/starRating.dart';

class ExpandedGold extends StatefulWidget {
  final txt;
  final data;
  const ExpandedGold({Key? key, this.txt, this.data}) : super(key: key);

  @override
  State<ExpandedGold> createState() => _ExpandedGoldState();
}

class _ExpandedGoldState extends State<ExpandedGold> {
  @override
  Widget build(BuildContext context) {
    final List<Chains> Chain = getChainData();
