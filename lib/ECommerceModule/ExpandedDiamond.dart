...
import 'package:stjewellery/ECommerceModule/Data/DiamondsData.dart';
import 'package:stjewellery/ECommerceModule/ProductDetailsPage.dart';
import 'package:stjewellery/Utils/starRating.dart';

class ExpandedDiamond extends StatefulWidget {
  final txt;
  final data;
  const ExpandedDiamond({Key? key, this.txt, this.data}) : super(key: key);

  @override
  State<ExpandedDiamond> createState() => _ExpandedDiamondState();
}

class _ExpandedDiamondState extends State<ExpandedDiamond> {
  @override
  Widget build(BuildContext context) {
    final List<Diamonds> Chain = getDiamondsData();
